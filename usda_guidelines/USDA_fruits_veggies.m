function []=USDA_fruits_veggies(question_mat1, question_mat2, question_mat3)
    ...
    question_final=question_final-q_3s; 

    for i=1:r 
        %if fullfill in one question
        index_yes1{i}=find(question_mat1(i,:)>=6);
        index_yes2{i}=find(question_mat2(i,:)>=6); 
        index_yes3{i}=find(question_mat3(i,:)>=6); 
