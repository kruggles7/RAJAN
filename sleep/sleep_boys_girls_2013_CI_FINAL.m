...
conf_mat{1,4}='7 hrs'; 
conf_mat{1,5}='8 hrs'; 
conf_mat{1,6}='9hrs or more'; 
conf_mat{1,7}='5hrs or less'; 
conf_mat{1,8}='6 hrs'; 
conf_mat{1,9}='7 hrs'; 
conf_mat{1,10}='8 hrs'; 
conf_mat{1,11}='9hrs or more'; 
conf_mat{1,12}='5hrs or less';
conf_mat{1,13}='6 hrs'; 
conf_mat{1,14}='7 hrs'; 
conf_mat{1,15}='8 hrs';  
conf_mat{1,16}='9hrs or more'; 
conf_mat{1,17}='5hrs or less';
conf_mat{1,18}='6 hrs'; 
conf_mat{1,19}='7 hrs'; 
conf_mat{1,20}='8 hrs';  
conf_mat{1,21}='9hrs or more'; 
conf_mat{2,1}='total'; 
conf_mat{3,1}='girls';
conf_mat{4,1}='boys';
conf_mat{5,1}='Wg';  
...
%	total(i)=TOTAL(i,1);
    for j=1:7
        ...
        elseif (j>5) %9 hours or more
            ...
            x_mat(:,5, i)=x_mat(:,5, i)+x(:,5);  
        else 
           
            x_mat(1,j-1, i)=total_yes(i); 
            x_mat(2,j-1, i)=yes_girls(i); 
            x_mat(3,j-1, i)=yes_boys(i); 
            x_mat(4,j-1, i)=yes_WG(i); 
            x_mat(5,j-1, i)=yes_WB(i); 
            x_mat(6,j-1, i)=yes_BG(i); 
            x_mat(7,j-1, i)=yes_BB(i);  
            x_mat(8,j-1, i)=yes_HG(i); 
            x_mat(9,j-1, i)=yes_HB(i); 
            x_mat(10,j-1, i)=yes_OG(i); 
            x_mat(11,j-1, i)=yes_OB(i); 
            x_mat(12,j-1, i)=yes_W(i); 
            x_mat(13,j-1, i)=yes_B(i); 
            x_mat(14,j-1, i)=yes_H(i); 
            x_mat(15,j-1, i)=yes_O(i); 
            x_mat(16,j-1, i)=yes_9(i); 
            x_mat(17,j-1, i)=yes_10(i); 
            x_mat(18,j-1, i)=yes_11(i); 
            x_mat(19,j-1, i)=yes_12(i);
            x_mat(20,j-1, i)=yes_9g(i); 
            x_mat(21,j-1, i)=yes_9b(i); 
            x_mat(22,j-1, i)=yes_10g(i); 
            x_mat(23,j-1, i)=yes_10b(i); 
            x_mat(24,j-1, i)=yes_11g(i); 
            x_mat(25,j-1, i)=yes_11b(i); 
            x_mat(26,j-1, i)=yes_12g(i); 
            x_mat(27,j-1, i)=yes_12b(i);
           
            x_mat(28,j-1, i)=yes_9HG(i); 
            x_mat(29, j-1, i)=yes_10HG(i); 
            x_mat(30, j-1, i)=yes_11HG(i); 
            x_mat(31, j-1, i)=yes_12HG(i); 
            x_mat(32, j-1, i)=yes_9HB(i); 
            x_mat(33, j-1, i)=yes_10HB(i); 
            x_mat(34, j-1, i)=yes_11HB(i); 
            x_mat(35, j-1, i)=yes_12HB(i); 
           
            x_mat(36, j-1, i)=yes_9WG(i); 
            x_mat(37, j-1, i)=yes_10WG(i); 
            x_mat(38, j-1, i)=yes_11WG(i); 
            x_mat(39, j-1, i)=yes_12WG(i); 
            x_mat(40, j-1, i)=yes_9WB(i); 
            x_mat(41, j-1, i)=yes_10WB(i); 
            x_mat(42, j-1, i)=yes_11WB(i); 
            x_mat(43, j-1, i)=yes_12WB(i);
           
            x_mat(44, j-1, i)=yes_9BG(i); 
            x_mat(45, j-1, i)=yes_10BG(i); 
            x_mat(46, j-1, i)=yes_11BG(i); 
            x_mat(47, j-1, i)=yes_12BG(i); 
            x_mat(48, j-1, i)=yes_9BB(i); 
            x_mat(49, j-1, i)=yes_10BB(i); 
            x_mat(50, j-1, i)=yes_11BB(i); 
            x_mat(51, j-1, i)=yes_12BB(i);
           
            x_mat(52, j-1, i)=yes_9OG(i); 
            x_mat(53, j-1, i)=yes_10OG(i); 
            x_mat(54, j-1, i)=yes_11OG(i); 
            x_mat(55, j-1, i)=yes_12OG(i); 
            x_mat(56, j-1, i)=yes_9OB(i); 
            x_mat(57, j-1, i)=yes_10OB(i); 
            x_mat(58, j-1, i)=yes_11OB(i); 
            x_mat(59, j-1, i)=yes_12OB(i);
