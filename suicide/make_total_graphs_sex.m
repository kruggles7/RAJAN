...
legend ('Been hit by boy/girlfriend', 'Forced to have sex', 'Ever had sex', 'Location', 'NorthWest');  
xlabel('Year','FontSize', 12);  
ylabel('% of Respondents Answering Positively', 'FontSize', 12); 
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'Sexual_violence_trends.png' );