...
legend ('Fasted to lose weight', 'Took a pill to lose weight', 'Vomited to lose weight', 'Location', 'SouthWest');  
xlabel('Year','FontSize', 12);  
ylabel('% of Respondents Answering Positively', 'FontSize', 12); 
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'Disordered_eating_trends.png' );