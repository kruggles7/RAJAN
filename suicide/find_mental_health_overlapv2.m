...
for k=1:r
    for j=1:z
        ...
        for i=1:z
            ...
            total_mat(j,i,k)=numel(indx1); 
            per_mat(j,i,k)=numel(over)/numel(indx1)*100; 
        end 
    end 
end 
...
saveas (gcf, 'mental_health_overlap_allv2.fig' ); %can make pdf, jnp, or jpg 
print (gcf, '-dpdf',  'mental_health_overlap_allv2');       
close