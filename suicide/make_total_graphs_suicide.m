...
legend ('Felt sad or hopeless', 'Ever considered suicide', 'Made a plan to commit suicide', 'Location', 'SouthWest');  
xlabel('Year','FontSize', 12);  
ylabel('% of Respondents Answering Positively', 'FontSize', 12); 
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'Suicide_trends_1.png' );