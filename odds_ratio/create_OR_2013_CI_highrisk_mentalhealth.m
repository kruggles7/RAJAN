...
for j=1:N
    ...
    if (isnan(q2_RC)==0) 
        ...
        for i=1:r1
            ...
            index_yes_1{i}=index_yes{i};
            index_no_1{i}=index_no{i};
            ...
            index_miss_1{i}=index_miss{i}; 
            %Q2:
            if q2_RC==1
                index_no{i}=find(quest_2F(i,:)==1);
                index_yes{i}=find(quest_2F(i,:)==0);
                index_yes_2{i}=index_yes{i};
                index_no_2{i}=index_no{i};
                index_miss{i}=find(quest_2F(i,:)==9);
                index_miss_2{i}=index_miss{i}; 
            else 
...
save('OR_2013_ALL_MentalHealth', 'odds_ratio_cell'); 
save('OR_CI_2013_ALL_MentalHealth', 'OR_CI'); 
