...
for G=1:2%gender
    ...
    if R==1
        if G==1
            save('OR_2013_WHITE_GIRLS_Q78_CAT5', 'odds_ratio_cell'); 
            save('OR_CI_2013_WHITE_GIRLS_Q78_CAT5', 'OR_CI'); 
        elseif G==2
            save('OR_2013_WHITE_BOYS_Q78_CAT5', 'odds_ratio_cell'); 
            save('OR_CI_2013_WHITE_BOYS_Q78_CAT5', 'OR_CI'); 
        end      
    end
    cd ..
end 