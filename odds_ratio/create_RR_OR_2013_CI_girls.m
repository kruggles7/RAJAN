		...
		if ( isnan(q2_RC)==0 && isnan(q1_RC)==0) 
            ...
            for i=1:r
                ...
                if q1_RC==1
                    ...
                    index_yesgirls_1{i}=intersect(index_yes{i},index_girls{i});
                    index_nogirls_1{i}=intersect(index_no{i},index_girls{i});
                ...
                if q2_RC==1
                    ...
                    index_yesgirls_2{i}=intersect(index_yes{i},index_girls{i});
                    index_nogirls_2{i}=intersect(index_no{i},index_girls{i});
                ...
                index_yes_both{i}=intersect(index_yesgirls_1{i}, index_yesgirls_2{i});  %students who said yes to both Qs
                index_no_both{i}=intersect(index_nogirls_1{i}, index_nogirls_2{i});  %student who said no to both Qs
                index_yes1_no2{i}=intersect(index_yesgirls_1{i}, index_nogirls_2{i});  %students who said yes to Q1 and no to Q2
                index_no1_yes2{i}=intersect(index_nogirls_1{i}, index_yesgirls_2{i});  %students who said no to Q1 and yes to Q2
...
cd ..
cd ..
save('OR_2013_girls', 'odds_ratio_cell'); 
save('OR_CI_2013_girls', 'OR_CI'); 