...
files1=dir(fullfile('C:','Users','kruggles7','Documents','MATLAB', 'Rajan', 'relative_risk_final','NaN_results_010314', '*.txt'));
	...
	for n=1:N
		...
		if ( isnan(q2_RC)==0 && isnan(q1_RC)==0) % won't compare a question to itself
			...
			if (r1~=r2)
				...
				for i=1:r
					a(i)=total_yes_girls(i);
					d(i)=total_no_girls(i);
					c(i)=total_yes1_no2_girls(i);
					b(i)=total_no1_yes2_girls(i);
				end
