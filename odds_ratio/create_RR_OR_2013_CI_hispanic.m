		...
		if ( isnan(q2_RC)==0 && isnan(q1_RC)==0) 
            ...
            for i=1:r
                ...
                if q1_RC==1
                    ...
                    index_yesH_1{i}=intersect(index_yes{i},index_H{i});
                    index_noH_1{i}=intersect(index_no{i},index_H{i});
                ...
                if q2_RC==1
                    ...
                    index_yesH_2{i}=intersect(index_yes{i},index_H{i});
                    index_noH_2{i}=intersect(index_no{i},index_H{i});
                ...
                index_yes_both{i}=intersect(index_yesH_1{i}, index_yesH_2{i});  %students who said yes to both Qs
                index_no_both{i}=intersect(index_noH_1{i}, index_noH_2{i});  %student who said no to both Qs
                index_yes1_no2{i}=intersect(index_yesH_1{i}, index_noH_2{i});  %students who said yes to Q1 and no to Q2
                index_no1_yes2{i}=intersect(index_noH_1{i}, index_yesH_2{i});  %students who said no to Q1 and yes to Q2
...
cd ..
cd ..
save('OR_2013_HISPANIC', 'odds_ratio_cell'); 
save('OR_CI_2013_HISPANIC', 'OR_CI'); 