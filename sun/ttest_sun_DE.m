...
[r,c]=size(q_mat); 
c_new=c-1; 
stat_mat=nan(c_new*6,7); 
stat_mat(1:c_new,1)=q_mat(1,2:c); 
...
stat_mat(c_new+1:c_new*2,1)=q_mat(2,2:c); 
...
stat_mat(c_new*2+1:c_new*3,1)=q_mat(3,2:c); 
...
stat_mat(c_new*3+1:c_new*4,1)=q_mat(4,2:c); 
...
stat_mat(c_new*4+1:c_new*5,1)=q_mat(5,2:c); 
...
stat_mat(c_new*5+1:c_new*6,1)=q_mat(6,2:c); 
