...
cd results_103114
cd cat
question_mat=importdata('Q78-cat-NaN.txt', '\t');
...
conf_mat=cell(59,10); 
conf_mat{1,2}='Ever'; 
conf_mat{1,3}='1-20 times'; 
conf_mat{1,4}='20+ times';  

conf_mat{1,5}='Ever'; 
conf_mat{1,6}='1-20 times'; 
conf_mat{1,7}='20+ times'; 

conf_mat{1,8}='Ever'; 
conf_mat{1,9}='1-20 times'; 
conf_mat{1,10}='20+ times';  
