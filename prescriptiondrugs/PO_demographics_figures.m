...
for i=1:N
    q=questions{i}; 
    question_mat=importdata([q '--NaN.txt'], '\t');
    ...
    index_missQ=find(Q1==9); %students who didn't answer the Q
    index_nomiss=find(Q1==0 | Q1==1); %answers that were NOT missing (ie. 0's and 1's / no's and yes's)
...
%label_y={'Prescription Drugs', 'Heroin', 'Methamphetamine', 'Cocaine',  'Ecstasy'}; 
label_y={'Prescription Drugs', 'Heroin'}; 
%label_x={'Total', 'Boys', 'Girls', 'W', 'W Boys', 'W Girls','B','B Boys', 'B Girls',  'H Boys', 'H Girls','H', 'O', 'O Boys', 'O Girls', '9th', '9th Boys', '9th Girls', '10th', '10th Boys', '10th Girls', '11th', '11th Boys', '11th Girls', '12th', '12th Boys', '12th Girls'}; 
%label_x={'Total', 'Boys', 'Girls', 'Total', 'Boys', 'Girls', 'Total', 'Boys', 'Girls', 'Total', 'Boys', 'Girls', 'Total', 'Boys', 'Girls', 'Total', 'Boys', 'Girls', 'Total', 'Boys', 'Girls', 'Total', 'Boys', 'Girls'};
...
xlim([0.5 27.5]); 
ylabel('Percentage of subjects reporting use >0 times'); 
%rotateXLabels(gca,90);
%tightfig

cd results
saveas(gcf, 'PO_heroin_demographics.fig'); 
%label_x={'Total', 'Boys', 'Girls', 'W', 'W Boys', 'W Girls','Males','B Boys', 'B Girls','H',  'H Boys', 'H Girls', 'O', 'O Boys', 'O Girls', '9th', '9th Boys', '9th Girls', '10th', '10th Boys', '10th Girls', '11th', '11th Boys', '11th Girls', '12th', '12th Boys', '12th Girls'}; 
%rework the order 
permat=per_mat; 
permat2=zeros(27,N); 
label_x2={'Total', 'W', 'Males', 'H', 'O', '9', '10', '11', '12','Total', 'W', 'Males', 'H', 'O', '9', '10', '11', '12','Total', 'W', 'Males', 'H', 'O', '9', '10', '11', '12'};  
permat2(1,:)=permat(1,:); 
permat2(2,:)=permat(4,:); 
permat2(3,:)=permat(7,:); 
permat2(4,:)=permat(10,:); 
...
xlim([0.5 27.5]); 
ylabel('Percentage of subjects reporting use >0 times'); 
saveas(gcf, 'PO_heroin_demographics2.fig'); 
