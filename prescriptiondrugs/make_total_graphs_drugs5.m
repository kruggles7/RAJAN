...
legend ('Ever used methamphetamines', 'Ever used ecstasy', 'Offered Drugs at school', 'Location', 'NorthWest');  
xlabel('Year','FontSize', 12);  
ylabel('% of Respondents Answering Positively', 'FontSize', 12); 
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'Drug_trends5.png' );