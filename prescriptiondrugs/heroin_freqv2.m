...
cd results_061514
cd NaN
question_mat=importdata('Q27--NaN.txt', '\t');
...
%per_mat=flipud(per_mat); 
    ...
    per_mat=per_mat/10; 
	h=figure; 
    title1={'During your life, how many times have you used heroin';  '(also called smack, junk or China White)?'}; 
	...
	saveas (gcf, 'heroin_heatmap.fig'); %can make pdf, jnp, or jpg 
    print (gcf, '-dpdf', 'heroin_heatmap.pdf'); 
