...
labels={'Prescription Drugs', 'Heroin', 'Injected Drugs'}; 
...
[r2,c2]=size(quest_2); 
q2_2011=quest_2(r2,2:c2); 

quest_3=importdata('Q31-cat-NaN.txt','\t'); 
[r3,c3]=size(quest_3); 
q3_2011=quest_3(r3,2:c3); 

indx_heroin=find(quest_2>1); 
indx_injection=find(quest_3>1); 
table_PO=cell.empty;  
...
indx=find(q1_2011>0 & q2_2011>0 & q3_2011>0 ); 
q1_2011=q1_2011(indx); 
q2_2011=q2_2011(indx); 
q3_2011=q3_2011(indx); 

indx2=find(q2_2011>1); 
indx_no2=find(q2_2011==1); 
table_PO{6,2}=numel(indx2);
indx3=find(q3_2011>1); 
indx_no3=find(q3_2011==1); 
table_PO{7,2}=numel(indx3);
indx_no1=find(q1_2011==1); 
indx1_=find(q1_2011>1); 
...
for i=1:max_-1
    indx1=find(q1_2011>i);
    indx2_=find(q2_2011>i); 
...
f1=subplot(3,1,1); 
x=1:2; 
plot(x,oi, '-ok', 'MarkerFaceColor','k'); 
set(gca,'xtick',[0 1 2]); 
set(gca, 'xticklabel', []); 
xlim([0.5 2.5]); 
ylim([0 400]); 
ylabel('Total Injection Users');
f2=subplot(3,1,2:3); 
...
xlim([0.5 2.5]); 
ylabel('% of Total Injection Users');
legend('Injected Only','Injected Drugs & Prescription Drugs', 'Injected Drugs & Heroin', 'Injected Drugs, Prescription Drugs, & Heroin ', 'Location','SouthOutside' ); 
%linkaxes([f1,f2], 'x'); 
...
f1=subplot(3,1,1); 
x=1:1:5; 
plot(x,o, '-ok', 'MarkerFaceColor','k'); 
%set(gcf,'xticks', []); 
set(gca,'xtick',[0 1 2 3 4 5]); 
set(gca, 'xticklabel', []); 
xlim([0.5 5.5]); 
ylim([0 3000]); 
ylabel('Total PO Users');
f2=subplot(3,1,2:3); 
bar(overlap,'stacked'); 
ylim([0 100]);  
labels={'>0 times', '>2 times', '>9 times', '>19 times', '>39 times'}; 
set(gca, 'xticklabel', labels); 
ylabel('% of Total PO Users');
legend('Prescription Drugs Only','Prescription Drugs & Heroin', 'Prescription Drugs & Injected Drugs', 'Prescription Drugs, Heroin & Injected Drugs', 'Location','SouthOutside' ); 
%linkaxes([f1,f2], 'x'); 
%find the current position [x,y,width, height]
pos1=get(f1,'Position'); 
pos2=get(f2,'Position'); 
...
f1=subplot(3,1,1); 
x=1:1:5; 
plot(x,o2, '-ok', 'MarkerFaceColor','k'); 
%set(gcf,'xticks', []); 
set(gca,'xtick',[0 1 2 3 4 5]); 
set(gca, 'xticklabel', []); 
xlim([0.5 5.5]); 
ylim([0 400]); 
ylabel('Total Heroin Users');
f2=subplot(3,1,2:3); 
bar(overlap2,'stacked'); 
ylim([0 100]);  
labels={'>0 times', '>2 times', '>9 times', '>19 times', '>39 times'}; 
set(gca, 'xticklabel', labels); 
ylabel('% of Total Heroin Users');
legend('Heroin Only','Heroin & Prescription Drugs', 'Heroin & Injected Drugs', 'Heroin, Prescription Drugs, & Injected Drugs', 'Location','SouthOutside' ); 
%linkaxes([f1,f2], 'x'); 
%find the current position [x,y,width, height]
pos1=get(f1,'Position'); 
pos2=get(f2,'Position'); 
