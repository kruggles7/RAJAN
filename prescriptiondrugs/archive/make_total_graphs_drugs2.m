...
legend ('Ever smoked marijuana', 'Smoked marijuana*', 'Smoked marijuana in school*', 'Location', 'NorthWest');  
xlabel('Year','FontSize', 12);  
ylabel('% of Respondents Answering Positively', 'FontSize', 12); 
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'Drug_trends2.png' );