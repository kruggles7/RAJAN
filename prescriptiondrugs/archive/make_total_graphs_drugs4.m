...
legend ('Ever used heroin', 'Ever used steroids', 'Ever used injected drugs', 'Location', 'NorthWest');  
xlabel('Year','FontSize', 12);  
ylabel('% of Respondents Answering Positively', 'FontSize', 12); 
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'Drug_trends4.png' );