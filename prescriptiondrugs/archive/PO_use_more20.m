...
for i=1:r
%	total(i)=TOTAL(i,1);
	index_yes{i}=find(question_mat(i,:)>4 & question_mat(i,:)<7);
...
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'PD_heatmap_20.png' );  %can make pdf, jnp, or jpg 

% %plot grade increases
...
% 
% legend ('Overall', 'Boys','Girls','Location', 'SouthWest');  
