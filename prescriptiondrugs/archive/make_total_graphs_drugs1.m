...
legend ('Drank alcohol*', 'Had 5+ drinks*', 'Drank alcohol in school*', 'Location', 'NorthWest');  
xlabel('Year','FontSize', 12);  
ylabel('% of Respondents Answering Positively', 'FontSize', 12); 
set (gca, 'FontSize',12); 
print (gcf,'-dpng', 'Drug_trends1.png' );