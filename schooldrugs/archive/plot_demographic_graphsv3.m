 function [per_mat1, per_mat2, ratio_mat] = plot_demographic_graphsv3( question_mat1, question_mat2, label )
cd ..
cd ..
cd data 
cd controls 
...
table_final=cell(16,7); 
table_final(2:16,1)=label_cell;
label_cell2={'2001', '2003', '2005', '2007', '2009', '2011'};
table_final(1,2:7)=label_cell2;
for i=1:15
    x1=[i i i i i i]; 
    ...
    for j=2:7
        table_final{i+1,j}=num2str(ratio(j-1)); 
    end 
end 
hold off
set(gca, 'Xtick', 1:15); 
