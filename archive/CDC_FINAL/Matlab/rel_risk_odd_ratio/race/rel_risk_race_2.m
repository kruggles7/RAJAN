%function [race_RR_cell] = rel_risk_race (quest_mat, filename, race1_choice, race2_choice)

function [race_RR_cell] = rel_risk_race_2 (race1_choice, race2_choice)
...
for p=1:P
	...
	if (strcmp(race1_choice,'W')==1)
		race1=1;
	elseif(strcmp(race1_choice,'B')==1);
		race1=2;
	elseif(strcmp(race1_choice,'H')==1)
		race1=3;
	elseif(strcmp(race1_choice,'O')==1)
		race1=4;
	else
...
%		break;
	...
	if (strcmp(race2_choice,'W')==1)
		race2=1;
	elseif(strcmp(race2_choice,'B')==1);
		race2=2;
	elseif(strcmp(race2_choice,'H')==1)
		race2=3;
	elseif(strcmp(race2_choice,'O')==1)
		race2=4;
	else
		print 'Not a valid response'
%		break;
	...
	for i=1:r
		...
		index_race1{i}=find(race_mat(i,:)==race1);
		index_race2{i}=find(race_mat(i,:)==race2);
	end
