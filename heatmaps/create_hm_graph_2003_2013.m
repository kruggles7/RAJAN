 function [per_mat_map] = create_hm_graph_2003_2013( question_mat, filename, race, sex, weight )
...
if r==6
    ...
    %Make heatmap
        ...
        set (gca, 'FontSize',12); 
        cd results
        saveas (gcf, [ filename '_heatmap_2003_2013.fig'] ); %can make pdf, jnp, or jpg 
        print (gcf, '-dpng',  [ filename '_heatmap_2003_2013.png']); 
        cd ..
        close all
else
