...
cutoff=input ('Enter the cutoff answer choice (not including that choice): '); 
direction=input ('Enter the direction (G for greater than, L for less than): ', 's'); 
...
cd programs
cd heatmaps
[conf_mat, total, x_mat, n_mat] = demographics_2013_CI_cutoff( question_mat, race, sex, grade, weight, years2, cutoff, direction );